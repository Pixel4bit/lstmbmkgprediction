...
if example_data: 
    ...
    fig.update_layout(height=600, title='Tingkat Akurasi antara Data Latih Aktual dan Data Latih Prediksi', xaxis_title='Jumlah Data', yaxis_title='Suhu')
